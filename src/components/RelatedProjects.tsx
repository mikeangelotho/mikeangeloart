      ...
      <div class="max-w-7xl mx-auto px-6 py-18 lg:py-36">
        <div class="flex flex-col gap-12">
          <div class="text-center lg:text-left">
            <h2 class="text-2xl lg:text-3xl font-bold text-black dark:text-white mb-4">
              Related Projects
            </h2>
            <p class="text-black/70 dark:text-white/70 max-w-2xl">
              Explore similar projects that showcase related skills and approaches in art direction, web design, and digital marketing.
            </p>
          </div>
                      ...
                      <div class="p-6">
                        <div class="flex items-start justify-between gap-4 mb-3">
                          <img
                            ...
                            loading="lazy"
                          />
                          <span class="text-xs text-black/50 dark:text-white/50 whitespace-nowrap">
                            {project.dateAdded}
                          </span>
                        </div>
