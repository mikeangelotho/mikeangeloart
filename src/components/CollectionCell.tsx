...
export function CollectionCell(props: {
  ...
  return (
    <article
      ...
      class={`not-dark:border not-dark:border-black/10 group/card cell-container relative overflow-hidden hover:brightness-115 hover:saturate-125 rounded-xl def__animate ${
        !props.enableFull ? `w-72 h-96 xl:h-108 md:w-100 xl:w-xl` : `h-120 w-full`
      }`}
    >
      <Show
